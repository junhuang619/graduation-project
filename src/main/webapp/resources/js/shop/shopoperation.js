...
$(function() {
	...
	var initUrl = '/xysp/shopadmin/getshopinitinfo';
	var registerShopUrl = '/xysp/shopadmin/registshop';
	// 通过shopId获取商铺信息的URL
	var getShopInfoByShopId = '/xysp/shopadmin/getshopbyid?shopId=' + shopId;
	// 修改商铺的URL
	var modifyShopUrl = '/xysp/shopadmin/modifyshop';
	...
	$('#submit').click(function() {
		...
		// 注意：
		// 这个地方的变量名称要和Shop实体类中的属性保持一致，因为后台接收到shopStr后，会将Json转换为实体类，如果不一致会抛出异常
