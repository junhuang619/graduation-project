...
$(function() {
	...
	// 商品添加URL
	var addProductURL = '/xysp/shopadmin/addproduct';
	// 商品编辑URL TODO
	var editProductURL = '/xysp/shopadmin/modifyproduct?productId=' + productId;
	// 获取商品初始化信息的URL 根据页面原型只需要获取productCategory即可，后台调用之前写好的路由方法即可
	var categoryInfoURL = '/xysp/shopadmin/getproductcategorybyshopId';
	// 商品编辑URL 用于从后台加载该product的基本信息，页面展示用
	var productInitURL = '/xysp/shopadmin/getproductbyid?productId=' + productId;
